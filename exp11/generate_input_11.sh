...
LOGFILE="$HOME/EntexExpress/exp11/generate_input_11.log"
exec &> >(tee -a "$LOGFILE")
...
grep "TissueSpecific=1" "${RUN_OUTPUT_PREFIX}.bed" > "${RUN_OUTPUT_PREFIX}_positive_only.bed"
BED_TO_USE="${RUN_OUTPUT_PREFIX}_positive_only.bed"

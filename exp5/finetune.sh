...
export DATA_PATH=~/EntexExpress/exp5/dnabert2_input
export OUTPUT_PATH=~/EntexExpress/exp5/dnabert2_output
export RUN_NAME=entex_express_exp5_dnabert2

export MAX_LENGTH=500 # set to 0.25 * your sequence length (2000)
export LR=3e-5

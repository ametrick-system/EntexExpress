...
LOGFILE="$HOME/EntexExpress/exp01_control/finetune.log"
exec &> >(tee -a "$LOGFILE")

# CONFIG
export FASTA_PATH=~/EntexExpress/exp01_control/promoters.fa

export DATA_PATH=~/EntexExpress/exp01_control/input
export OUTPUT_PATH=~/EntexExpress/exp01_control/output
export RUN_NAME=entex_express_exp01_control
...
config_dnabert2_input_random_bins(
    fasta='${FASTA_PATH}',
    save_prefix='/home/asm242/EntexExpress/exp01_control/input',
    labels=[0, 1]
)
"

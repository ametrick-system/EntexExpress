...
LOGFILE="$HOME/EntexExpress/exp7/finetune.log"
exec &> >(tee -a "$LOGFILE")

# Change for each experiment
export DATA_PATH=~/EntexExpress/exp7/input
export OUTPUT_PATH=~/EntexExpress/exp7/output
export RUN_NAME=entex_express_exp7
